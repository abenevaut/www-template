...
{{--        <a href="{{ route('login_provider', ['provider' => \template\Infrastructure\Interfaces\Domain\Users\ProvidersTokens\ProvidersInterface::GITHUB]) }}" class="btn btn-block btn-default btn-github">--}}
{{--            <i class="fab fa-github mr-2"></i>{{ trans('auth.login_github') }}--}}
{{--        </a>--}}
...
{{--        </a>--}}
{{--        <a href="{{ route('login_provider', ['provider' => \template\Infrastructure\Interfaces\Domain\Users\ProvidersTokens\ProvidersInterface::TWITTER]) }}" class="btn btn-block btn-default btn-twitter">--}}
{{--            <i class="fab fa-twitter mr-2"></i>{{ trans('auth.login_twitter') }}--}}
{{--        </a>--}}
{{--        <a href="{{ route('login_provider', ['provider' => \template\Infrastructure\Interfaces\Domain\Users\ProvidersTokens\ProvidersInterface::LINKEDIN]) }}" class="btn btn-block btn-default btn-linkedin">--}}
{{--            <i class="fab fa-linkedin mr-2"></i>{{ trans('auth.login_linkedin') }}--}}
{{--        </a>--}}
{{--    </div>--}}
{{--    <hr/>--}}
